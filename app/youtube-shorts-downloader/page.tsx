  ...
  const customFaqs = [
    {
      ...
      a: "In the YouTube app on your phone, open the Short, tap the 'Share' arrow icon, and select 'Copy link'. Then return to WaveForge, tap 'Paste', and click Convert.",
    },
    {
      q: "Can I extract only the audio track from a YouTube Short?",
      a: "Yes! Simply choose MP3 as the output format. WaveForge will isolate the viral background track or speech from the vertical video and save it as a clean MP3 file.",
    },
  ];
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 text-zinc-300 text-sm leading-relaxed">
        ...
        <p className="text-zinc-400 mb-4">
          Whether you want to save inspirational speeches, trending dance audio, or comedy skits from YouTube Shorts, WaveForge supports native vertical aspect ratio (9:16) rendering with zero quality loss.
        </p>
      </div>
