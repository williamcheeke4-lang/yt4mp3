  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 text-zinc-300 text-sm leading-relaxed border-t border-white/5">
        ...
        <p className="mb-4 text-zinc-400">
          WaveForge utilizes direct media stream demuxing. When you supply a YouTube video or Shorts link, our distributed edge pipeline isolates the native Opus audio track (sampled at 48,000 Hz) and packages it directly into the MP3, WAV, or M4A container of your choice.
        </p>
