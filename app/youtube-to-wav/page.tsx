...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.rootvogue.com/youtube-to-wav",
  },
};
...
export default function YoutubeToWavPage() {
  const customFaqs = [
    ...
    },
    {
      ...
      a: "Yes. RootVogue works in Safari on iOS, macOS, Chrome on Windows, and Android. The extracted .wav file can be downloaded directly into your system files with zero conversion software or plugins.",
    },
  ];
